		...
		if (txtWebMsg.startsWith("sub")) {
		 ...
		 if(!(txtWebMsg.equals("sub"))){
			...
			if (isValid == 1) {
				...
				out.println(String.format(pageHtml,
						"You have reached the maximum limit of 5 subscription.<br>"
						+ "SMS @feeds MYSUB to view your current subscriptions.<br>"
						+ "SMS @feeds UNSUB [id] to view list of all feeds.<br>"
						+ "SMS @feeds UNSUB ALL to view list of all feeds.<br>"
						+ "SMS @feeds LIST to view list of all subscriptions.<br>"
						));
